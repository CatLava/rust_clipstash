...
// This clip structure needs to be entirely different from the domain
// Layer of abstraction between domain and database layer
...
// try frp, convert domain clip to data
// convert from data base into domain verions
...
// need to convert from one model into the next
// takes one clip into the other clip
...
// impl an into function for working with get clip
